<style>
    ...
    .nav-link {
        ...
        cursor: pointer; /* Menambahkan cursor pointer untuk semua nav-link */
    }
    ...
    /* ============================================
       TREEVIEW - Submenu dengan display yang benar
       ============================================ */
    .nav-treeview {
        padding-left: 0;
        margin-top: 0.25rem;
    ...
    .nav-item.menu-open > .nav-treeview {
        display: block !important; /* Tampilkan ketika menu-open */
        opacity: 1;
    ...
    .nav-item.menu-open > .nav-treeview .nav-item {
        opacity: 1;
        transform: translateX(0);
    }

    /* Stagger animation untuk item treeview */
    .nav-item.menu-open > .nav-treeview .nav-item:nth-child(1) { transition-delay: 0.05s; }
    .nav-item.menu-open > .nav-treeview .nav-item:nth-child(2) { transition-delay: 0.1s; }
    .nav-item.menu-open > .nav-treeview .nav-item:nth-child(3) { transition-delay: 0.15s; }
    .nav-item.menu-open > .nav-treeview .nav-item:nth-child(4) { transition-delay: 0.2s; }
    .nav-item.menu-open > .nav-treeview .nav-item:nth-child(5) { transition-delay: 0.25s; }
    ...
    /* ============================================
       ARROW INDICATOR - Dropdown dengan animasi
       ============================================ */
    .nav-arrow {
        margin-left: auto;
        font-size: 0.75rem;
    ...
    @media (max-width: 768px) {
        ...
        .nav-link {
            ...
            /* Pastikan klik bekerja di mobile */
            touch-action: manipulation;
        }

        /* Perbesar area klik untuk mobile */
        .nav-link,
        .nav-link > * {
            pointer-events: auto !important;
        }

        /* Arrow lebih besar di mobile */
        .nav-arrow {
            font-size: 0.875rem;
        }
        ...
        /* Submenu lebih terlihat di mobile */
        .nav-treeview .nav-link {
...
<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark" id="appSidebar">
    <!--begin::Sidebar Brand-->
...
<script>
// JavaScript untuk menangani toggle menu di semua device (termasuk mobile)
document.addEventListener('DOMContentLoaded', function() {
    ...
    function toggleMenu(menuItem) {
        ...
        // Buka menu yang diklik jika sebelumnya tertutup
        if (!isOpen) {
    ...
    document.addEventListener('click', function(e) {
        const isClickInsideSidebar = document.getElementById('appSidebar').contains(e.target);
    ...
    // Handle ketika klik link di submenu, tutup menu parent di mobile
...
window.addEventListener('resize', function() {
    if (window.innerWidth > 768) {
        // Di desktop, biarkan menu tetap terbuka jika perlu
    } else {
        // Di mobile, bisa tambahkan logika khusus jika perlu
    }
});
</script>